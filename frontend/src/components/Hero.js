...
const styles = {
  hero: { minHeight: '100vh', background: 'linear-gradient(135deg, #0a1628 0%, #1a3a6b 50%, #1e4080 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden', padding: '6rem 1.25rem 4rem' },
  overlay: { position: 'absolute', inset: 0, background: 'radial-gradient(circle at 30% 50%, rgba(59,130,246,0.15) 0%, transparent 60%)' },
  ...
  btnOutline: { border: '1px solid rgba(255,255,255,0.3)', color: 'white', padding: '0.85rem 2rem', borderRadius: '3px', textDecoration: 'none', fontWeight: '500', fontSize: '0.88rem' },
  stats: { display: 'flex', justifyContent: 'center', flexWrap: 'wrap', borderTop: '1px solid rgba(255,255,255,0.1)' },
