      ...
      <div style={styles.container}>
        <div style={styles.grid}>
          ...
          <div>
            ...
            <ul style={styles.links}>
            killall -9 node              <li><span style={styles.link}>21/3 Munai Street, Batticaloa</span></li>
...
const styles = {
  footer: { background: '#0a1628', color: 'rgba(255,255,255,0.7)', padding: '4rem 2rem 2rem' },
  container: { maxWidth: '1100px', margin: '0 auto' },
  grid: { display: 'grid', gridTemplateColumns: '2fr 1fr 1fr', gap: '3rem', marginBottom: '3rem' },
  ...
  bottom: { paddingTop: '2rem', borderTop: '1px solid rgba(255,255,255,0.08)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '0.75rem', flexWrap: 'wrap', gap: '0.5rem' },
