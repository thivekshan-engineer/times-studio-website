        ...
        <div style={{
          ...
          {tabs[activeTab].map((service, i) => (
            <div key={i} style={styles.card}>
              ...
              <div style={styles.cardTag}>{service.tag}</div>
            </div>
          ))}
        </div>
      </div>
...
const styles = {
  ...
  cardDesc: { fontSize: '0.85rem', color: '#64748b', lineHeight: '1.7', marginBottom: '1rem' },
  cardTag: { fontSize: '0.78rem', fontWeight: '600', color: '#3b82f6' }
};
